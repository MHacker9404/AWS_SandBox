...
import { PipelineProject, LinuxBuildImage, BuildEnvironmentVariableType, Cache, BuildSpec } from '@aws-cdk/aws-codebuild';
...
export class CpBackendStack extends Stack {
    constructor(scope: Construct, id: string, props: PipelineProps) {
        ...
        const build = new PipelineProject(this, 'backend-build', {
            ...
            buildSpec: BuildSpec.fromObject({
                ...
                phases: {
                    ...
                    build: {
                        commands: ['echo "--Build PHASE--"', `serverless deploy`],
                    },
                },
                artifacts: {
                    files: ['**/*'],
        ...
        pipeline.addStage({
            ...
            actions: [
                new GitHubSourceAction({
                    ...
                    output: sourceOutput,
                    repo: 'devops', //  this may need to be case specic
                    branch: 'master', //  this may need to be case specic
                    owner: 'MHacker9404', //  this was case specific :(
        ...
        //  an exmaple of how to do the permissions more explicitly
        ...
        new StringParameter(this, 'accountId', {
            parameterName: `/${environment}/account-id`,
            stringValue: account_id,
            type: ParameterType.STRING,
        });
        new StringParameter(this, 'region', {
            parameterName: `/${environment}/region`,
            stringValue: region,
            type: ParameterType.STRING,
        });
    }
